...
<%
    ...
    Boolean defeatedPremium = (Boolean) sessionsa.getAttribute("defeatedPremium");
...
<script>
    ...
    if('<%=defeatedPremium%>' !== 'null')
        if('<%=defeatedPremium%>' === 'true')
            alert('Tu cuenta premium esta vencida... ');


    <%
        sessionsa.setAttribute("defeatedPremium",null);
    %>
  var myIndex=0;
  carousel();
