        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status === "200") {
                    ...
                    if(!data.data.finish)
                        buttonToPay.append('<button type="button" class="btn-finish btn-login" onclick="confim()" ><span class="content">Terminar</span></button>');
                }
                else {
                    alert(data.status);
                }
...
<div class="container">
    <form name="login" class="formContent" action="finishService.jsp" id="pay-form" method="post" accept-charset="utf-8">
