        ...
        success: function (data) {
            if (data.status === "200") {
                ...
                data.data.forEach(function (item, index) {
                    result.append('<tr>');
                    result.append('<td><a href="updateService.jsp?serviceID=' + item.id + '">' + item.id + '</a></td>');
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status === "200") {
                    ...
                    data.data.forEach(function (item, index) {
                        if (index === 0)
                            result.append('<label><input type="radio" name="type" checked value="' + item.id + '" /> ' + item.name + '</label>');
                        else
                            result.append('<label><input type="radio" name="type" value="' + item.id + '" /> ' + item.name + '</label>');
                    });
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status === "200") {
                                ...
                                $("input[name=type][value='" + data.data.serviceType.id + "']").prop("checked",true);
