 ...
 * Generated at: 2017-03-04 20:52:22 UTC
...
public final class updateService_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (token != null) {
      ...
      out.write("<script>\n");
      out.write("    $.ajax({\n");
      out.write("        url: \"http://localhost:8095/api_job/private/api/v1/getServicesByUser/");
      out.print(userName);
      out.write("\",\n");
      out.write("        type: \"GET\",\n");
      ...
      out.write("                    result.append('<tr>');\n");
      out.write("                    result.append('<td><a href=\"updateService.jsp?serviceID=' + item.id + '\">' + item.id + '</a></td>');\n");
      ...
      out.write("            <li><a class=\"active\" href=\"listService.jsp\">Actualizar servicio</a></li>\n");
      ...
      out.write("    <form name=\"save\" class=\"formContent\" action=\"listService.jsp\" id=\"save-form\" method=\"post\">\n");
      ...
      out.write("\n");
      out.write("        <div class=\"headers\">\n");
      out.write("            <label for=\"type\">Tipo de servicio:</label>\n");
      out.write("\n");
      out.write("            <div name=\"result\" id=\"result\"></div>\n");
      out.write("        </div>\n");
      out.write("\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js\"></script>\n");
      out.write("<script>\n");
      out.write("    showServicesType();\n");
      out.write("    function showServicesType() {\n");
      out.write("\n");
      out.write("        $.ajax({\n");
      out.write("            url: \"http://localhost:8095/api_job/private/api/v1/getAllServices\",\n");
      out.write("            type: \"GET\",\n");
      out.write("            contentType: \"application/json; charset=utf-8\",\n");
      out.write("            dataType: \"json\",\n");
      out.write("            beforeSend: function (xhr) {\n");
      ...
      out.write("                            result.append('<label><input type=\"radio\" name=\"type\" checked value=\"' + item.id + '\" /> ' + item.name + '</label>');\n");
      out.write("                        else\n");
      out.write("                            result.append('<label><input type=\"radio\" name=\"type\" value=\"' + item.id + '\" /> ' + item.name + '</label>');\n");
      out.write("                    });\n");
      out.write("\n");
      out.write("\n");
      out.write("                    //charge my service\n");
      out.write("                    $.ajax({\n");
      out.write("                        url: \"http://localhost:8095/api_job/private/api/v1/getServicesByUserAndId/");
      out.print(userName);
      out.write('/');
      out.print(serviceID);
      out.write("\",\n");
      ...
      out.write("                                $(\"input[name=type][value='\" + data.data.serviceType.id + \"']\").prop(\"checked\",true);\n");
      out.write("\n");
      out.write("                            }\n");
      out.write("                            else {\n");
      ...
      out.write("\n");
      out.write("        $.ajax({\n");
      out.write("            url: \"http://localhost:8095/api_job/private/api/v1/updateService/");
      out.print(serviceID);
      out.write("/\" + $('#description').val() + \"/\" + $('#name').val() + \"/\" + $('#price').val() + \"/\" + $('input:radio[name=type]:checked').val() + \"/");
      out.print(userName);
      out.write("\",\n");
      out.write("            type: \"POST\",\n");
      out.write("            contentType: \"application/json; charset=utf-8\",\n");
