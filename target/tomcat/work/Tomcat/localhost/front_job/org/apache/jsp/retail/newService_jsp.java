 ...
 * Generated at: 2017-03-03 05:35:49 UTC
...
public final class newService_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (token != null) {
      ...
      out.write("            <li><a class=\"active\" href=\"newService.jsp\">Nuevo servicio</a></li>\n");
      ...
      out.write("    <form name=\"save\" class=\"formContent\" action=\"/front_job/retail/index.jsp\" id=\"save-form\" method=\"post\">\n");
      ...
      out.write("                            result.append('<label>' + item.name + '</label><input type=\"radio\" name=\"type\" checked value=\"' + item.id + '\" /> ');\n");
      out.write("                        else\n");
      out.write("                            result.append('<label>' + item.name + '</label><input type=\"radio\" name=\"type\" value=\"' + item.id + '\" /> ');\n");
      out.write("                    });\n");
      ...
      out.write("\n");
      out.write("        $.ajax({\n");
      out.write("            url: \"http://localhost:8095/api_job/private/api/v1/saveNewService/\" + $('#description').val() + \"/\" + $('#name').val() + \"/\" + $('#price').val() + \"/\" + $('input:radio[name=type]:checked').val() + \"/");
      out.print(userName);
      out.write("\",\n");
      out.write("            type: \"POST\",\n");
      out.write("            contentType: \"application/json; charset=utf-8\",\n");
